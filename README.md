...
⚠️ **This project use to create a  social media app where users to connect with people made on React Native.**

**Perfect to start an Twitter Clone app.** 4 screens are availables : Explore, Login, Register, Password Reset, Dashboard, Matches, Messages and Profile. You'll find some components like Card Component to pass props and variant. No frameworks UI like Bootstrap or Material UI are used.
...
```
git clone https://github.com/bazzeff/twiiter-clone
cd tinder-expo
```
